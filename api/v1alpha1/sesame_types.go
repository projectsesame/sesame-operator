...
// Sesame is the Schema for the Sesames API.
...
// SesameNodePlacement describes node scheduling configuration for Sesame pods.
// If nodeSelector and tolerations are specified, the scheduler will use both to
// determine where to place the Sesame pod(s).
...
func init() {
	SchemeBuilder.Register(&Sesame{}, &SesameList{})
}
