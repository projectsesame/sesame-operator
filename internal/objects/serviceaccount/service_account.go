...
import (
	...
	utilequality "github.com/projectsesame/sesame-operator/internal/equality"
...
func EnsureServiceAccount(ctx context.Context, cli client.Client, name string, Sesame *operatorv1alpha1.Sesame) (*corev1.ServiceAccount, error) {
	desired := DesiredServiceAccount(name, Sesame)
	current, err := CurrentServiceAccount(ctx, cli, Sesame.Spec.Namespace.Name, name)
	if err != nil {
	...
	updated, err := updateSvcAcctIfNeeded(ctx, cli, Sesame, current, desired)
	if err != nil {
...
// given sesame.
func DesiredServiceAccount(name string, Sesame *operatorv1alpha1.Sesame) *corev1.ServiceAccount {
...
func updateSvcAcctIfNeeded(ctx context.Context, cli client.Client, Sesame *operatorv1alpha1.Sesame, current, desired *corev1.ServiceAccount) (*corev1.ServiceAccount, error) {
